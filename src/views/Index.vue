      ...
      <h3 class="pb-3">
        ...
        <div class="row mb-2">
          ...
          <div class="col-md-7 pl-0">
            <div class="row pr-3">
              <div v-for="(p,i) in others" :key="i" class="col-md-4 p-0 pl-2">
                <div class="card border-0 text-center">
                  ...
                  <div class="card-body p-0 pr-1 pl-1">
                    ...
                    <router-link class="btn btn-sm btn-primary" :to="`/details/${p3.href.split('=')[1]}`">查看详情</router-link>
                  </div>
                </div>
              </div>
            </div>
...
export default {
  ...
  mounted() {
    this.axios.get("/index").then(result=>{
          ...
          this.others=result.data.splice(3);
        });
  }
}
</script>
